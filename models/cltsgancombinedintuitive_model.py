...
class CLTSGANCombinedIntuitiveModel(BaseModel):
    """
    ...
    def set_input(self, combined_input):
        ...
        """
        A_from_combined = combined_input[1].image
        combined_input[0]['A'] = A_from_combined
