...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # dataset parameters
        parser.add_argument('--dataset_mode', type=str, default='unalignedintu', help='chooses how datasets are loaded. [unalignedintu | unaligned | aligned | single | colorization]')
